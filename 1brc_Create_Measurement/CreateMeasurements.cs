...
namespace _1brc_Create_Measurements;
...
public static class CreateMeasurements
{
    ...
    private record WeatherStation(string Id, double MeanTemperature)
    {
        public double GetMeasurement()
        {
            ...
            {
                return Math.Round(MeanTemperature + random.NextDouble() * 7, 1);
            }
            else
            {
                return Math.Round(MeanTemperature - random.NextDouble() * 7, 1);
    ...
    public static async Task Generate(int size)
    {
        ...
        using (var writer = File.AppendText(InputFileName))
        {
            for (int i = 0; i < size; i++)
            {
                ...
                {
                    Console.WriteLine($"Wrote {i} measurements {stopWatch.ElapsedMilliseconds} ms");
                }
        ...
        Console.WriteLine($"Created file with {size} measurements in {stopWatch.ElapsedMilliseconds} ms");
    }
}